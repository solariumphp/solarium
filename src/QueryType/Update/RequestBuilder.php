...
class RequestBuilder extends BaseRequestBuilder
{
     ...
     * @return string
     */
    public function buildAddXml(Add $command, UpdateQuery $query = null): string
    {
        $xml = '<add';
     ...
     * @return string
     */
    protected function buildFieldXml(string $name, float $boost, $value, string $modifier = null, UpdateQuery $query = null): string
    {
        $xml = '<field name="'.$name.'"';
     ...
     * @return string
     */
    private function buildFieldsXml(string $key, float $boost, $value, string $modifier, UpdateQuery $query): string
    {
        $xml = '';
        if (is_array($value)) {
